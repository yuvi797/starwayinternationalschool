...
export function LeadershipSlider() {
    ...
    const leaders = [
        {
            ...
            fallbackImage: "https://via.placeholder.com/400x400?text=Director",
        ...
        },
        {
            ...
            fallbackImage: "https://via.placeholder.com/400x400?text=Principal",
    ...
    // Check if images exist and load fallbacks if needed
    useEffect(() => {
        leaders.forEach((leader) => {
            const img = new Image();
            img.onload = () => setImagesLoaded(true);
            img.onerror = () => {
                leader.image = leader.fallbackImage;
                                ...
                                <div className="relative group">
                                    ...
                                    <div className="relative overflow-hidden rounded-2xl shadow-xl">
                                        <img
                                            ...
                                            onError={(e) => {
                                                e.target.onerror = null;
                                                e.target.src = leaders[currentIndex].fallbackImage;
                                            }}
                                        />
                                ...
                                <div className="flex flex-col justify-center space-y-6">
                                    ...
                                    <div className="space-y-3 pt-4">
                                        <div className="flex items-center space-x-3 text-gray-600">
                                            ...
                                            <span>rajeshkumarverma95818@gmail.com</span>
                                        </div>
                                        <div className="flex items-center space-x-3 text-gray-600">
                                            <svg className="w-5 h-5 text-accent-raspberry" fill="currentColor" viewBox="0 0 20 20">
